...
func declarationRoutes(group *echo.Group) {
	...
	group.DELETE("/list/item-index/:projectID/:name/:itemIndex/:locale", lists.DeleteListItemByIndexHandler())
	...
	group.GET("/lists/query-index/:projectID/:name/:locale/:index", lists.QueryListByIndexHandler())
