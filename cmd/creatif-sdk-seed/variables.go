...
func addToList(client *http.Client, projectId, name string, variable dataGeneration.PropertyVariable, connections []map[string]string, imagePaths []string) http2.HttpResult {
	body := map[string]interface{}{
		"name": name,
		"variable": map[string]interface{}{
			"name":      variable.Name,
