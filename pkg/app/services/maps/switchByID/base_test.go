...
func TestApi(t *testing.T) {
	...
	GinkgoRunSpecs(t, "Maps - Switch by ID")
}
...
func testCreateMap(projectId, name string, variablesNum int) []map[string]string {
	...
	return sdk.Map(view.Variables, func(idx int, value mapCreate.ViewVariable) map[string]string {
